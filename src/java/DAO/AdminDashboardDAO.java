...
public class AdminDashboardDAO extends DBContext {
     ...
     * @return UserStatusCount object containing counts of active, inactive, and pending users
     */
     ...
     * @return List of CategoryCount objects containing name and count of level 1 categories
     */
     ...
     * @return ProductStatusCount object containing counts of active, inactive, and EOStock products
     */
     ...
     * @return List of CustomerSpendData objects with customer spending information
     */
     ...
     * @return CustomerSpendData object with aggregated customer spending information
     */
    public CustomerSpendData getTotalCustomerStats() {
        CustomerSpendData totals = new CustomerSpendData();
        
        String sql = "SELECT SUM(total_purchases) AS total_purchases, SUM(total_spend) AS total_spend " +
        ...
        try {
            ...
            if (rs.next()) {
                totals.setTotalPurchases(rs.getInt("total_purchases"));
                totals.setTotalSpend(rs.getBigDecimal("total_spend"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
     ...
     * @return List of TimeSeriesData objects with month and product count information
     */
     ...
     * @return List of TimeSeriesData objects with month and order count information
     */
